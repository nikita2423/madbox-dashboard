...
import type { OverallInsightsRequest, OverallInsightsResponse } from '../types';
import { API_URL } from '@/lib/utils';

// Backend API URL
const BACKEND_API_URL = `${API_URL}/api/bank-post/overall-insights`;
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { query, start_date, end_date } = body;
    ...
    console.log('Forwarding topic to backend API:', query);
    ...
    let data: OverallInsightsResponse;
    try {
