...
import type { ChartStatsRequest, ChartStatsResponse } from '../types';
import { API_URL } from '@/lib/utils';

// Backend API URL
const BACKEND_API_URL = `${API_URL}/api/bank-post/charts-stats-data`;
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { topic, keywords, start_date, end_date } = body;
