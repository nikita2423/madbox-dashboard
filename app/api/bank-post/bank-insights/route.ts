...
import type { BankInsightsRequest, BankInsightsResponse } from '../types';
import { API_URL } from '@/lib/utils';

// Backend API URL
const BACKEND_API_URL = `${API_URL}/api/bank-post/relevant-posts`;
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { query, bank, start_date, end_date } = body;
